...
const content = `const cache = new Map()
...
writeFileSync("C:/proyectos/trailblaze/backend/src/services/weather.service.js", content)
console.log("weather.service.js creado")
