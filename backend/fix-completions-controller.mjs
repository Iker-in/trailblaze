...
const content = `import prisma from '../config/prisma.js'
...
writeFileSync("C:/proyectos/trailblaze/backend/src/controllers/completions.controller.js", content)
console.log("completions.controller.js creado")
