...
const content = `export function pointToSegmentDistanceMeters(lat, lng, aLat, aLng, bLat, bLng) {
...
writeFileSync("C:/proyectos/trailblaze/backend/src/utils/routeCoverage.js", content)
console.log("routeCoverage.js creado")
