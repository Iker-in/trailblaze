    ...
    <nav style={{background: "#050B18", borderBottom: "1px solid #1A3050", padding: "0 24px", height: "60px", display: "flex", justifyContent: "space-between", alignItems: "center"}}>
      ...
      <div style={{display: "flex", alignItems: "center", gap: "24px"}}>
        ...
        {isAuthenticated ? (
          ...
          <>
            <Link to="/login" style={{color: "#FFB88A", fontSize: "14px", textDecoration: "none", fontWeight: "500"}}>Iniciar sesion</Link>
            <Link to="/register" style={{background: "#FFB88A", color: "#050B18", padding: "7px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: "bold", textDecoration: "none"}}>
              Registrarse
            </Link>
          </>
        )}
