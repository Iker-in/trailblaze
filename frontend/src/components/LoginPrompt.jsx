  ...
  return (
    <div style={{background: "#0D1F35", border: "1px solid #1A3050", borderRadius: "14px", padding: "24px", textAlign: "center", margin: "12px 0"}}>
      ...
      <div style={{display: "flex", gap: "10px", justifyContent: "center"}}>
        <Link to="/register" style={{background: "#F2854D", color: "white", padding: "10px 20px", borderRadius: "10px", fontSize: "14px", fontWeight: "500", textDecoration: "none"}}>Crear cuenta</Link>
