          ...
          {isAuthenticated ? (
            <>
              ...
              <div style={{display: "flex", gap: "12px", justifyContent: "center"}}>
                <Link to="/routes" style={{background: "#eab308", color: "#0f172a", padding: "12px 28px", borderRadius: "12px", fontWeight: "bold", fontSize: "15px", textDecoration: "none"}}>Explorar rutas</Link>
                <Link to="/routes/create" style={{border: "1px solid #334155", color: "#94a3b8", padding: "12px 28px", borderRadius: "12px", fontSize: "15px", textDecoration: "none"}}>Publicar ruta</Link>
              </div>
            </>
          ) : (
            <>
              ...
              <div style={{display: "flex", gap: "12px", justifyContent: "center"}}>
                <Link to="/register" style={{background: "#eab308", color: "#0f172a", padding: "12px 28px", borderRadius: "12px", fontWeight: "bold", fontSize: "15px", textDecoration: "none"}}>Crear cuenta</Link>
                <Link to="/login" style={{border: "1px solid #334155", color: "#94a3b8", padding: "12px 28px", borderRadius: "12px", fontSize: "15px", textDecoration: "none"}}>Iniciar sesion</Link>
              </div>
            </>
          )}
        </div>
        ...
        {isAuthenticated && (
          <div style={{marginBottom: "60px"}}>
            <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px"}}>
              ...
              <Link to="/routes" style={{color: "#7c3aed", fontSize: "14px", textDecoration: "none"}}>Explorar todas</Link>
            </div>
            {feedLoading ? (
              ...
              <div style={{background: "#1e293b", border: "1px solid #334155", borderRadius: "14px", padding: "40px", textAlign: "center"}}>
                ...
                <Link to="/ranking" style={{background: "#7c3aed", color: "white", padding: "10px 24px", borderRadius: "10px", fontSize: "14px", textDecoration: "none", fontWeight: "500"}}>Descubrir senderistas</Link>
              </div>
            )}
          </div>
        )}
        ...
        {popular.length > 0 && (
          <div style={{marginBottom: "60px"}}>
            <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px"}}>
              ...
              <Link to="/routes" style={{color: "#7c3aed", fontSize: "14px", textDecoration: "none"}}>Ver todas</Link>
            </div>
            <div style={{display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "16px"}}>
        ...
        <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "60px"}}>
          <div style={{background: "#1e293b", border: "1px solid #334155", borderRadius: "14px", padding: "20px"}}>
            <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px"}}>
              ...
              <Link to="/ranking" style={{color: "#7c3aed", fontSize: "13px", textDecoration: "none"}}>Ver ranking</Link>
            </div>
