        ...
        <div style={{textAlign: "center", marginBottom: "60px"}}>
          {isAuthenticated ? (
            <>
              ...
              <p style={{color: "#4A6480", fontSize: "16px", margin: "0 0 28px"}}>Listo para tu proxima aventura?</p>
              <div style={{display: "flex", gap: "12px", justifyContent: "center"}}>
                <Link to="/routes" style={{background: "#eab308", color: "#050B18", padding: "12px 28px", borderRadius: "12px", fontWeight: "bold", fontSize: "15px", textDecoration: "none"}}>Explorar rutas</Link>
                <Link to="/routes/create" style={{border: "1px solid #1A3050", color: "#6B8CAE", padding: "12px 28px", borderRadius: "12px", fontSize: "15px", textDecoration: "none"}}>Publicar ruta</Link>
              </div>
            </>
          ) : (
            <>
              ...
              <p style={{color: "#4A6480", fontSize: "18px", margin: "0 0 32px"}}>Descubre, comparte y conquista rutas de senderismo</p>
              <div style={{display: "flex", gap: "12px", justifyContent: "center"}}>
                <Link to="/register" style={{background: "#eab308", color: "#050B18", padding: "12px 28px", borderRadius: "12px", fontWeight: "bold", fontSize: "15px", textDecoration: "none"}}>Crear cuenta</Link>
                <Link to="/login" style={{border: "1px solid #1A3050", color: "#6B8CAE", padding: "12px 28px", borderRadius: "12px", fontSize: "15px", textDecoration: "none"}}>Iniciar sesion</Link>
              </div>
            </>
          )}
        </div>
        ...
        {stats && (
          <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "60px"}}>
            {[
              ...
              <div key={stat.label} style={{background: "#0D1F35", border: "1px solid #1A3050", borderRadius: "14px", padding: "24px", textAlign: "center"}}>
